...
// DEFINITION DU PORT 
// Fonction permettant d'écouter la variable d'environnement du port grâce à process.env.PORT : 
// si la plateforme de déploiement propose un port par défaut, c'est celui-ci qu'on écoutera ;
// OU le port 3000, qui nous servira dans le cas de notre plateforme de développement.
